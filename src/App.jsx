...
import { Heart, MessageCircle, Users, Calendar, User, Search, Send, X, Menu, Moon, Sun, MapPin, Check, AlertCircle } from 'lucide-react';
  ...
  useEffect(() => {
    if (currentScreen === 'home' && userProfile.interests.length >= 2) {
      const filteredMatches = mockUsers.filter(user => {
        ...
        // Enkel sjekk: Matcher enten på eksakt lokasjon eller viser alle hvis ingen matcher lokalt (demo)
